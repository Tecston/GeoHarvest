  ...
  return (
    ...
    >
      ...
      <div className="text-balance relative z-20 mx-auto mb-4 mt-4 max-w-4xl text-center text-3xl font-semibold tracking-tight text-gray-700 dark:text-neutral-300 md:text-7xl">
        <Balancer>
          <motion.h2>
            {"Conectamos tecnología, datos y experiencia para transformar el campo"
              .split(" ")
              .map((word, index) => (
                <motion.span
                  initial={{
      ...
      >
        GeoHarvest es una plataforma Agrofintech que revoluciona la agricultura al ayudar a los agricultores a mejorar sus decisiones y optimizar sus recursos. 
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <Button
          ...
          href="/login"
          variant="dark"
          className=" md:block w-40 text-center"
        >
          Registrarse
        </Button>
        <a className="md:block w-40" href="mailto:support@geoharvest.org">
...
// Animation for the collision mechanism
