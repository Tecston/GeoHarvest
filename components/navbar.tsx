  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <a href="mailto:support@geoharvest.org" className="hidden md:block ">
    ...
    <>
      ...
      >
        <div className="flex flex-row justify-between items-center w-full">
          <Logo />
          <div className="flex flex-row justify-between items-center min-w-[10%] ">
          <ModeToggle />
          {open ? (
            <IconX
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              ...
              <a  href="mailto:support@geoharvest.org"               className="block md:hidden w-full"
>
